<%@ Page Title="Modifier une Fonction d'Agent" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ModifierAgentFonction.aspx.cs" Inherits="GestionRHv2.Pages.AgentsFonctions.ModifierAgentFonction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="breadcrumb">
            <a href="ListeAgentsFonctions.aspx">🎯 Fonctions d'Agents</a> / ✏️ Modifier une Fonction
        </div>
        ...
        <div class="form-card">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <span class="info-text">Le numéro ne peut pas être modifié</span>
                </div>
