<%@ Page Title="Ajouter un Agent" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AjouterAgent.aspx.cs" Inherits="GestionRHv2.Pages.Agents.AjouterAgent" %>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtMatricule" runat="server" CssClass="form-control" 
                                ...
                                OnTextChanged="txtMatricule_TextChanged"></asp:TextBox>
                    <small class="field-hint">
                        ⚠️ Le matricule doit être unique (minimum 3 caractères)
                    </small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small class="field-hint">
                        ⚠️ Le CIN doit être unique (minimum 5 caractères)
                    </small>
                </div>
